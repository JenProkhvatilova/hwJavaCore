...
public class Triangle extends javaCoreHW.hw7.GeometricShapes {
    protected double triangleSideAB;
    protected double triangleSideBC;
    protected double triangleSideAC;
    protected int triangleAngleA;
    protected int triangleAngleB;
    protected int triangleAngleC;
